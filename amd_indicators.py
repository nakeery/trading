...
def plot_dashboard(df):
    ...
    plot_df = df[df.index >= df.index.max() - pd.Timedelta(days=180)]
    ...
    plt.savefig("amd_dashboard.png", dpi=150, bbox_inches="tight",
                facecolor="#0d1117")
    print("Chart saved → amd_dashboard.png")
    plt.show()
...
if __name__ == "__main__":
    ...
    df.to_csv("amd_indicators.csv")
    print("Full indicator data saved → amd_indicators.csv")