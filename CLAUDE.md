...
| lens.py | 1 (ticker; or `--ticker QQQ JPM …` to skip prompt) + argparse flags (--thesis / --level / --geo / --no-intraday / --no-vix / --no-color / --candle box\|braille\|sixel\|none / --candle-px N / --prev N / --no-refresh / --refresh / --as-of YYYY-MM-DD / --pc-oi [all\|near\|leaps\|monthly …] / --vol / --call / --gex / --live / --squeeze / --insider / --street / --movers) |
